...
const SpeedDial = React.forwardRef(function SpeedDial(props, ref) {
  ...
  const actionsPlacementClass = clsx(direction === 'up' && classes.directionUp, direction === 'down' && classes.directionDown, direction === 'left' && classes.directionLeft, direction === 'right' && classes.directionRight);
  let clickProp = {
    onClick
  };
