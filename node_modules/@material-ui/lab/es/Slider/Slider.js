...
class Slider extends React.Component {
  constructor(...args) {
    ...
    this.handleRef = ref => {
      setRef(this.props.innerRef, ref); // #StrictMode ready
  ...
  calculateValueFromPercent(event) {
    ...
    const percent = calculatePercent(this.container, event, vertical, this.isReverted(), this.touchId);
  ...
  render() {
    ...
    const _this$props = this.props,
      ...
      vertical
          ...
          other = _objectWithoutPropertiesLoose(_this$props, ["className", "classes", "component", "thumb", "disabled", "innerRef", "max", "min", "onChange", "onDragEnd", "onDragStart", "step", "theme", "value", "valueReducer", "vertical"]);
